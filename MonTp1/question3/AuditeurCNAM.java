...
public class AuditeurCNAM {
    ...
    public String login() {
        ...
        String result = nom().substring(0,min).toLowerCase().replaceAll("[^A-Za-zÀ-ÿ]+","_")+"_"+prenom().substring(0,1).toLowerCase().replaceAll("[^A-Za-zÀ-ÿ]+","_");
        
        return Normalizer.normalize(result, Normalizer.Form.NFD)
                     .replaceAll("\\p{InCombiningDiacriticalMarks}+", "");// à compléter
    }
